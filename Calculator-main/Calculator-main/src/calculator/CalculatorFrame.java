...
public class CalculatorFrame extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        /* Establece el aspecto de Nimbus */
        //<editor-fold defaultstate=«collapsed» desc=« Código de configuración del aspecto (opcional)»>
        /* Si Nimbus (introducido en Java SE 6) no está disponible, mantenga el aspecto por defecto.
